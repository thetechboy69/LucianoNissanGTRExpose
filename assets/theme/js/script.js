...
(function () {
  ...
  function y(a, c, e) {
    ...
    b.getAttribute("style") ||
      b.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;");
    k.contains("row") && (k.remove("row"), k.add("media-container-row"));
  ...
  Element.prototype.footerReveal = function () {
    function a() {
      !g && c.offsetHeight <= window.outerHeight
        ? ((c.style.zIndex = "-999"),
    ...
    window.addEventListener("scroll", function () {
      ...
      if (p) {
        ...
        b
          ? c != p.fixed &&
            (m
              ? ((p.fixed = c), p.elm.classList.toggle("is-fixed"))
    ...
    f(document).on("add.cards", function (a) {
      f(a.target).find(".form-with-styler").length &&
        ...
        f(a)
          ...
          .each(function () {
            f(this).datetimepicker &&
              f(this).datetimepicker({ format: "Y-m-d", timepicker: !1 });
          }),
        f(a)
          .find("input[type=time]")
          .each(function () {
            f(this).datetimepicker &&
              f(this).datetimepicker({ format: "H:i", datepicker: !1 });
          }));
    });
  }
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.com/builder/ai-website-generator.html">AI Website Generator</a> Mobirise v5.9.18 <a href="https://mobirise.com/builder/ai-website-maker.html">Free AI Website Maker</a>';
